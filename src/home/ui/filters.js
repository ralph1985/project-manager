...
export function applySavedFilters(elements, saved) {
  ...
  setSelected(elements.projectFilter, saved.project);
}

export function readFilters(elements) {
  ...
  return {
    ...
    project: selectedValues(elements.projectFilter),
